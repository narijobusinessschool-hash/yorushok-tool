...
// 流れ文字のコピー（心理学的訴求）
const TICKER_ITEMS = [
  "✦ 1日あたりコーヒー1杯以下。でも、指名の差は何万円にもなる。受講生100名が実証済み。月額9,800円",
  "✦ 毎月リセット・月10回無料。まず使って、効果を体感してから決めればいい",
  "✦ 指名が変わった子は全員「文章を変えた」。センスじゃなくて型がある。月額9,800円",
  "✦ 使えば使うほど賢くなるAIが、あなただけの文章の型を作る",
  "✦ 「スコア30点上がったら指名も増えた」。数字で見えるから続けられる",
  "✦ 本気の子だけが使っている。添削・動画・アーカイブ、全部込みで月額9,800円",
  "✦ 1指名の差が月に何万円の差になるか。文章に投資する子が稼ぐ",
];
